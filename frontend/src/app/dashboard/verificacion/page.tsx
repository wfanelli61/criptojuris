...
export default function VerificacionPage() {
 ...
 borderRadius: '8px', fontSize: '0.9rem', background: 'rgba(255,255,255,0.04)',
 };
 ...
 background: s <= step ? 'var(--color-gold)' : 'rgba(255,255,255,0.08)',
 ...
 {error && (
 <div style={{ padding: '0.75rem', background: '#FEE2E2', color: '#F87171', borderRadius: '8px', marginBottom: '1rem', fontSize: '0.85rem' }}>
 {error}
 </div>
 )}
 ...
 {step === 1 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>1️⃣ Datos Personales y Profesionales</h2>
 <div style={gridStyle}>
 <div>
 ...
 {step === 2 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>2️⃣ Áreas de Especialización</h2>
 ...
 {step === 3 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>3️⃣ Experiencia Profesional</h2>
 <div style={gridStyle}>
 <div>
 ...
 {step === 4 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>4️⃣ Evaluación Ética y Profesional</h2>
 {[
 ...
 {step === 5 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>5️⃣ Referencias y Portafolio</h2>
 <div style={gridStyle}>
 <div>
 ...
 {step === 6 && (
 <div>
 <h2 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#F1F5F9' }}>6️⃣ Disponibilidad y Modalidad</h2>
 <div style={gridStyle}>
 <div>
 ...
 style={{ padding: '0.6rem 1.5rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.04)', cursor: 'pointer', fontSize: '0.9rem' }}>
 ← Anterior
 </button>
 ) : <div />}
