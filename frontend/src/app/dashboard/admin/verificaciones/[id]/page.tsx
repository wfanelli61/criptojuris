...
export default function AdminVerificacionDetailPage() {
 ...
 const sectionTitleStyle: React.CSSProperties = { fontSize: '1rem', fontWeight: 700, color: '#F1F5F9', marginBottom: '0.75rem', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: '0.4rem' };
 const fieldStyle: React.CSSProperties = { marginBottom: '0.5rem', fontSize: '0.85rem' };
 const labelStyle: React.CSSProperties = { fontWeight: 600, color: 'rgba(255,255,255,0.65)', marginRight: '0.3rem' };
 ...
 <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.45)' }}>{profile.user?.email}</p>
 </div>
 ...
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '0.25rem 1rem' }}>
 ...
 <span key={s} style={{ padding: '0.2rem 0.6rem', background: 'rgba(212,168,71,0.15)', color: '#F59E0B', borderRadius: '12px', fontSize: '0.75rem', fontWeight: 600 }}>{s}</span>
 ))}
 </div>
 ...
 <div style={{ marginTop: '0.5rem', padding: '0.75rem', background: 'rgba(255,255,255,0.04)', borderRadius: '8px' }}>
 <p style={{ ...labelStyle, display: 'block', marginBottom: '0.3rem' }}>Caso complejo:</p>
 <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.5 }}>{v.complexCaseStory}</p>
 </div>
 </div>
 ...
 <div key={q.label} style={{ marginBottom: '0.75rem', padding: '0.6rem', background: 'rgba(255,255,255,0.04)', borderRadius: '6px' }}>
 <p style={{ fontWeight: 600, fontSize: '0.8rem', color: 'rgba(255,255,255,0.65)', marginBottom: '0.2rem' }}>{q.label}</p>
 <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)' }}>{q.value}</p>
 </div>
 ))}
 </div>
 ...
 <div key={i} style={{ padding: '0.5rem', background: 'rgba(255,255,255,0.04)', borderRadius: '6px', marginBottom: '0.4rem', fontSize: '0.85rem' }}>
 ...
 <span key={l} style={{ padding: '0.15rem 0.5rem', background: 'rgba(59,130,246,0.08)', color: '#60A5FA', borderRadius: '10px', fontSize: '0.75rem' }}>{l}</span>
 ))}
 </div>
 )}
 </div>
 ...
 style={{ padding: '0.65rem 1.5rem', borderRadius: '8px', border: '1px solid #DC2626', background: 'rgba(255,255,255,0.04)', color: '#DC2626', cursor: 'pointer', fontWeight: 600, fontSize: '0.9rem' }}>
 Rechazar
 </button>
