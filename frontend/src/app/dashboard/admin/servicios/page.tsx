...
export default function AdminServiciosPage() {
 ...
 <h1 style={{ fontSize: '1.6rem', color: '#F1F5F9' }}>Gestión de Servicios</h1>
 ...
 <div className="form-group"><label className="form-label">Ícono</label><input className="form-input" value={form.icon} onChange={(e) => setForm({ ...form, icon: e.target.value })} placeholder="" /></div>
 </div>
