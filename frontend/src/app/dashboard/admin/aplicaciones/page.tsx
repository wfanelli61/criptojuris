...
export default function AdminApplicationsPage() {
 ...
 return (
 <div>
 <h1 style={{ fontSize: '1.6rem', color: '#F1F5F9', marginBottom: '1.5rem' }}>
 ...
 <tr><td colSpan={5} style={{ textAlign: 'center', padding: '2rem', color: 'rgba(255,255,255,0.45)' }}>No hay solicitudes pendientes.</td></tr>
 ) : (
